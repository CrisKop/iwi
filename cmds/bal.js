...
exports.run = async(client, message, args, Discord) =>{
 ...
 return message.channel.send(new Discord.RichEmbed()
                        .setAuthor(message.author.tag, message.author.displayAvatarURL)
                             .addField('Efectivo:', `<:coin:716941705793765377> ${usuariocash}`, true)
                             .addField('Banco:', `<:coin:716941705793765377> ${usuariobank}`, true)
                             .addField('Total:', `<:coin:716941705793765377> ${usuariototalmoney}`, true)
                             .setTimestamp()
                             .setColor(0x24caf0)
                             );
  } else {
